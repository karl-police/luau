...
// Apparently this was removed and is not in the original luau repository anymore.
// So I should remove this as well if I don't believe that I used to modify this or log it.
