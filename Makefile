...
BYTECODEPARSER_CLI_SOURCES=CLI/FileUtils.cpp CLI/Flags.cpp CLI/BytecodeParser.cpp
BYTECODEPARSER_CLI_OBJECTS=$(BYTECODEPARSER_CLI_SOURCES:%=$(BUILD)/%.o)
BYTECODEPARSER_CLI_TARGET=$(BUILD)/luau-bytecode_parser
